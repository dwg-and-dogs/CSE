...
ExecutiveFGroup:
	...
	db 32, ARBOK,      SCREECH, POISON_STING, CRUNCH, GLARE
	db 32, VILEPLUME,  SWORDS_DANCE, MOONLIGHT, SLEEP_POWDER, ACID
	db 32, MURKROW,    WING_ATTACK, FAINT_ATTACK, HAZE, NIGHT_SHADE
	db 32, MUK,        SLUDGE, MINIMIZE, SCREECH, FIRE_PUNCH
	db -1 ; end

	; EXECUTIVEF (2)
	db "ARIANA@", TRAINERTYPE_MOVES
	db 23, ARBOK,      GLARE, WRAP, POISON_STING, BITE
	db 23, GLOOM,      MEGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, ACID
	db 25, MURKROW,    PECK, PURSUIT, HAZE, NIGHT_SHADE
	db 25, GRIMER,     SLUDGE, MINIMIZE, DISABLE, MUD_SLAP
	db -1 ; end
	
	db "ARIANA@", TRAINERTYPE_MOVES
	db 12, EKANS,       WRAP, LEER, POISON_STING, NO_MOVE
	db 12, ODDISH,      ABSORB, SWEET_SCENT, NO_MOVE, NO_MOVE
	db 11, GRIMER,      POISON_GAS, DISABLE, HARDEN, POUND
...
GiovanniGroup:
	; GIOVANNI (1) in safari zone
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 48, PINSIR,     SWORDS_DANCE, HIDDEN_POWER, SUBMISSION, GUILLOTINE
	db 48, MAROWAK,    BONEMERANG, FOCUS_ENERGY, THRASH, CURSE
	db 48, PARASECT,   SWORDS_DANCE, LEECH_LIFE, SLASH, STUN_SPORE
	db 52, KANGASKHAN, DIZZY_PUNCH, REVERSAL, BITE, MEGA_PUNCH
	db 48, EXEGGUTOR,  EGG_BOMB, SWEET_SCENT, PSYCHIC_M, MOONLIGHT
	db -1 ; end
	
	; GIOVANNI (2) in silph, frustration
	db "GIOVANNI@", TRAINERTYPE_HAPPINESS |TRAINERTYPE_MOVES
	db 54, TAUROS
		db $00
		db PURSUIT, FRUSTRATION, RAGE, REST ; Bite is an egg move
	db 54, CROBAT
		db $00
		db WING_ATTACK, FAINT_ATTACK, MEAN_LOOK, CONFUSE_RAY ; Bite is an egg move
	db 54, HOUNDOOM
		db $00
		db CRUNCH, FLAMETHROWER, SMOG, ROAR ; Bite is an egg move
	db 56, PORYGON2
		db $00
		db RECOVER, TRI_ATTACK, ZAP_CANNON, LOCK_ON ; Bite is an egg move
	db 58, MACHAMP
		db $00
		db CROSS_CHOP, SCARY_FACE, BODY_SLAM, FIRE_PUNCH ; Bite is an egg move
	db -1 ; end

	; GIOVANNI (3) in Cerulean Cave
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 62, NIDOKING,   EARTHQUAKE, THUNDER, SURF, TOXIC
	db 62, NIDOQUEEN,  EARTHQUAKE, ICE_BEAM, ATTRACT, SLUDGE_BOMB
	db 64, RHYDON,     EARTHQUAKE, ROCK_SLIDE, SCARY_FACE, STRENGTH
	db 68, PERSIAN,    SLASH, SCREECH, DETECT, SWAGGER
	db 66, DUGTRIO,    EARTHQUAKE, SAND_ATTACK, SLASH, SCREECH
	db 70, MEWTWO,     PSYCHIC_M, FIRE_PUNCH, THUNDERPUNCH, SWIFT
	db -1 ; end
